/**
 * Classes used during the actual Denali server execution to handle requests.
 *
 * @module denali
 * @submodule runtime
 */
const { Injection } = require('./inject');
...
function giveMethodSuper(superclass, name, fn) {
  ...
  return function wrapSuper(...args) {
