...
// left off - trying to get tests passing.
...
export default class CommandAcceptanceTest {
  ...
  populateWithDummy() {
    ...
    let projectNodeModules = path.join(this.projectRoot, 'node_modules');
    ...
    // Symlink the addon's dependencies into the tmp dummy app
    symlinkAll(projectNodeModules, tmpNodeModules);
