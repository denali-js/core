...
loaded into memory. Type \`.help\` in the REPL environment for more details.
  ...
  run() {
    return BuildCommand.prototype.build.call(this).then(() => {
      ...
      if (!UserApplication || Object.getPrototypeOf(UserApplication) !== Application) {
        ui.error(`Unable to load your application - expected /app/application.js to export a subclass of Application, but found ${ application } instead.`);
        process.exit(1);
      }
