...
export default class Blueprint {
  ...
  destroy(args) {
    ...
    // Ensure that the dest file actually exists
      ...
      if (!fileExists) {
        ui.raw(`  ${ chalk.grey('missing') } ${ destRelativepath }\n`);
      }
      return fileExists;
    ...
    // ensure we don't destroy code
      ...
      if (destFileIsNotDirty) {
        ui.raw(`  ${ chalk.red('destroy') } ${ destRelativepath }\n`);
      } else {
        ui.raw(`  ${ chalk.blue('skipped') } ${ destRelativepath }\n`);
      }
