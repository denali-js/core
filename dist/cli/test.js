...
program.option('-g --grep <regex filter>', 'Filter tests based on a regex pattern').option('-e --environment <environment>', 'The environment to run in; defaults to "test"', 'test').parse(process.argv);
