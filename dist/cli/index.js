...
program.version(pkg.version).command('new', 'scaffold a new denali project').command('server', 'run the denali app server').command('console', 'launch your denali app in a REPL environment').command('generate', 'generate boilerplate code from templates').command('destroy', 'remove scaffolding created by the generate command').command('test', 'run the test suite, and optionally re-run on changes');
